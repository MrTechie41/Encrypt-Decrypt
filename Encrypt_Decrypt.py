...
wn = Tk()
wn.geometry("500x500")
wn.configure(bg='goldenrod')
wn.title("Encrypt and Decrypt your Messages with Encrypt-Decrypt")
...
headingFrame1 = Frame(wn,bg="magenta4",bd=5)
headingFrame1.place(relx=0.2,rely=0.1,relwidth=0.7,relheight=0.16)

headingLabel = Label(headingFrame1, text=" Welcome to Encryption and \nDecryption with Encrypt-Decrypt", fg='magenta4', font=('Courier',13,'bold'))
headingLabel.place(relx=0,rely=0, relwidth=1, relheight=1)


label1 = Label(wn, text='Enter the Message', fg='magenta4', font=('Courier',10, 'bold'))
label1.place(x=10,y=150)

msg = Entry(wn,textvariable=Message, width=35, font=('calibre',10,'normal'))
msg.place(x=200,y=150)

label2 = Label(wn, text='Enter the key', fg='magenta4', font=('Courier',10, 'bold'))
label2.place(x=10,y=200)

InpKey = Entry(wn, textvariable=key,  width=35,font=('calibre',10,'normal'))
InpKey.place(x=200,y=200)

label3 = Label(wn, text='Check one of encrypt or decrypt', fg='magenta4', font=('Courier',10, 'bold'))
label3.place(x=10,y=250)

Radiobutton(wn, text='Encrypt', fg='magenta4', variable=mode, value=1).place(x=100,y=300) 
Radiobutton(wn, text='Decrypt', fg='magenta4', variable=mode, value=2).place(x=200,y=300) 

label3 = Label(wn, text='Result', fg='magenta4', font=('Courier',10, 'bold'))
...
ShowBtn = Button(wn,text="Show Message",bg='green2', fg='black',width=15,height=1,command=Result)
ShowBtn['font'] = font.Font( size=12)
ShowBtn.place(x=180,y=400)

ResetBtn = Button(wn, text='Reset', bg='cyan2', fg='black', width=15,height=1,command=Reset)
